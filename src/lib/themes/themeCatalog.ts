...
export const APP_THEMES: Record<AppThemeId, AppTheme> = {
  acid_cyberpunk: {
    ...
    emoji: '⚡',
    badge: 'CYBER LIME',
    gradient: 'linear-gradient(135deg, #C8F04B 0%, #22C55E 100%)',
    font: 'Syne Bold Cyber',
    signatureFx: '⚡ Resplandor 200W Alto Voltaje',
  ...
  oled_sapphire: {
    ...
    font: 'DM Sans Geometric',
    signatureFx: '💎 Crystalline Glass Refráctil',
  ...
  vaporwave_sunset: {
    ...
    font: 'Syne Italic Retro',
    signatureFx: '🌅 Horizonte Radial & Rejilla 80s',
  ...
  amethyst_royal: {
    ...
    emoji: '🔮',
    badge: 'ULTRAVIOLET GEM',
    gradient: 'linear-gradient(135deg, #A855F7 0%, #C084FC 100%)',
    font: 'Syne Imperial',
    signatureFx: '✨ Polvo de Estrellas Ultravioleta',
  ...
  emerald_aurora: {
    ...
    font: 'DM Sans Humanist',
    signatureFx: '🌌 Cortina Boreal Polar Menta',
  ...
  solar_amber: {
    ...
    font: 'Syne Serif Vintage',
    signatureFx: '📻 Válvula de Vacío Analógica',
  ...
  crimson_velocity: {
    ...
    emoji: '🩸',
    badge: 'SUPERCAR CARBON',
    gradient: 'linear-gradient(135deg, #EF4444 0%, #F87171 100%)',
    font: 'Syne Tech Racing',
    signatureFx: '🏎️ Malla Carbono & Bisel Escarlata',
  ...
  oceanic_abyss: {
    ...
    emoji: '🌊',
    badge: 'DEEP OCEAN',
    gradient: 'linear-gradient(135deg, #06B6D4 0%, #2DD4BF 100%)',
    font: 'DM Sans Fluid',
    signatureFx: '🐠 Bioluminiscencia Abisal Aqua',
  ...
  matcha_zen: {
    ...
    font: 'DM Sans Wabi-Sabi',
    signatureFx: '🎍 Pizarra Bambú & Piedra Rodada',
  ...
  cotton_candy: {
    ...
    emoji: '🍬',
    badge: 'DREAM POP',
    gradient: 'linear-gradient(135deg, #EC4899 0%, #818CF8 100%)',
    font: 'Syne Bubbly Pop',
    signatureFx: '☁️ Azúcar Glass 30px & Nube Pastel',
  ...
  matrix_terminal: {
    ...
    font: 'JetBrains Mono Code',
    signatureFx: '📟 Scanlines CRT & Prompt >_',
  ...
  titanium_luxury: {
    ...
    emoji: '🪙',
    badge: 'TITANIUM STUDIO',
    gradient: 'linear-gradient(135deg, #E2E8F0 0%, #94A3B8 100%)',
    font: 'DM Sans Studio',
    signatureFx: '⌚ Titanio Cepillado & Platino B&O',
  ...
  original_minimalist: {
    ...
    gradient: 'linear-gradient(135deg, #C8F04B 0%, #A6C955 100%)',
    font: 'DM Sans Clean',
    signatureFx: '🖤 Negro Acústico Mate Absoluto',
    accentPrimary: '#C8F04B',
